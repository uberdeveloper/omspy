...
@pytest.mark.parametrize(
    ...
    [
        ...
        ((1000, 1300, 1104, None, None, 50), (650, None)),
        ((1000, 1300, 1104, 2200, None, 50), (650, 2200)),
        ((1000, 1300, 1104, None, -1000, 50), (650, None)),
        ((1000, -1300, 1104, 2200, -1000, 50), (-650, 2200)),
        ((1000, -1300, 1104, 2200, -1000, 10), (-1170, 2200)),
        ((1000, 1674, 1104, 2400, -1500, 50, None, 300), (750, 2400)),
        ((1000, 1674, 1104, 2400, -1500, 50, 550, 300), (750, 2400)),
        ((1000, 1850, -300, 1600), (None, 1600)),
        ((1000, -1200, -1500, 1600, -700), (-700, 1600)),
        ((1000, 2178, 1020, 2600, -1500, 50, None, None, 1800), (1089, 2600)),
        ((1000, 1178, 1020, 2600, -1500, 50, None, None, 1800), (-1500, 2600)),
        ((1000, 1578, 1020, 2600, -1500, 50, 300, 600, 1100), (600, 2600)),
        ((1000, 1240, 900, 1200, None), (None, 1200)),
        ((1000, 1240, 900, None, -1000), (-1000, None)),
        ((1000, 1240, 900, 1200, -1000), (-1000, 1200)),
        ((750, 1200, 600, 1200, -1000, None, 300, None, None), (900, 1200)),
        ((-600, -300, -700, 1200, -1000, None, 600, None, None), (300, 1200)),
        ((-1600, -1200, -1700, 1200, -1000, None, 600, None, None), (-600, 1200)),
        ((754, 1300, 600, 1200, -1000, None, 300, 300, None), (900, 1200)),
        ((754, 1300, 600, 1200, -1000, None, 300, 300, 1500), (-1000, 1200)),
        ((754, 1300, 600, 1200, -1000, None, 300, 300, 1000), (900, 1200)),
        ((754, 1100, 600, 1200, -1000, None, 300, 300, 1000), (600, 1200)),
    ],
    ids=[
        "no_tgt_no_stop",
        "tgt_no_stop",
